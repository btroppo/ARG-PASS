...
To run the ARG-PASS pipeline in full and reproduce figures from the manuscript go to https://zenodo.org/records/18817276/ and follow the README there. To simply run an example here follow instructions below:
